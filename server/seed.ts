...
const seedData = async () => {
  try {
    ...
    console.log("Database connected for seeding. Clearing data...");
    ...
    console.log("Creating restaurants and bookings...");
    ...
    const updatedRestaurants = restaurantData.map((rest, idx) => {
      const { ...restInfo } = rest;
      return {
        ...restInfo,
        owner: owner._id,
